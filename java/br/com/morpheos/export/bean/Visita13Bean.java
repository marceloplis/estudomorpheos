...
public class Visita13Bean {
	...
	@SheetHeader( name = "Mudança de medicação ?")
	private String mudancaMedicacao;

	@SheetHeader( name = "Adesão Medicamentosa (%)")
	private Double adesaoMedicamentosa;
	...
	public String getMudancaMedicacao() {
		return mudancaMedicacao;
	}

	public void setMudancaMedicacao(String mudancaMedicacao) {
		this.mudancaMedicacao = mudancaMedicacao;
	}

	public Double getAdesaoMedicamentosa() {
		return adesaoMedicamentosa;
	}

	public void setAdesaoMedicamentosa(Double adesaoMedicamentosa) {
